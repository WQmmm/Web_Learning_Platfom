    ...
    <div class="wrapper clearfix">
        <div class="zuo fl">
            <h3><a href="#"><img src="img/tx.png"/></a>
                <p class="clearfix"><span class="fl">[${username}]</span><a href="index.jsp">[退出登录]</a></p></h3>
            <div><h4>我的交易</h4>
                <ul>
        ...
        <div class="you fl">
            ...
            <c:forEach var="u" items="${paybeanList}">
            <div class="dkuang">
                <div class="word clearfix">
                <div class="shohou clearfix"><a href="#" class="fl"><img src="img/sql/${u.location}"/></a>
                    <p class="fl"><a href="#">${u.courseName}</a></p>
