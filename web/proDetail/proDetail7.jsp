...
<div class="detCon">
    <div class="proDet wrapper">
        <div class="proCon clearfix">
            <div class="proImg fl"><img class="det" src="../img/sql/007.jpg"/>
            </div>
            <div class="fr intro">
                <div class="title"><h4>MySQL从入门到精通</h4>
...
<script type="text/javascript">$(".buy,.cart").click(function () {
    <%
        session.setAttribute("courseName","MySQL从入门到精通");
        session.setAttribute("location","007.jpg");
    %>
});</script>
</body>
</html>