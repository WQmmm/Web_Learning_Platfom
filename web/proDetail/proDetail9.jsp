...
<div class="detCon">
    <div class="proDet wrapper">
        <div class="proCon clearfix">
            <div class="proImg fl"><img class="det" src="../img/sql/009.jpg"/>
            </div>
            <div class="fr intro">
                <div class="title"><h4>MySQL入门与基础管理</h4>
...
<script type="text/javascript">$(".buy,.cart").click(function () {
    <%
        session.setAttribute("courseName","MySQL入门与基础管理");
        session.setAttribute("location","009.jpg");
    %>
});</script>
</body>
</html>