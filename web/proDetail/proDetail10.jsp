...
<div class="detCon">
    <div class="proDet wrapper">
        <div class="proCon clearfix">
            <div class="proImg fl"><img class="det" src="../img/sql/010.png"/>
            </div>
            <div class="fr intro">
                <div class="title"><h4>一次性搞定数据库事务</h4>
...
<script type="text/javascript">$(".buy,.cart").click(function () {
    <%
        session.setAttribute("courseName","一次性搞定数据库事务");
        session.setAttribute("location","010.png");
    %>
});</script>
</body>
</html>