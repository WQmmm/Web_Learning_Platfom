...
<div class="detCon">
    <div class="proDet wrapper">
        <div class="proCon clearfix">
            <div class="proImg fl"><img class="det" src="../img/sql/011.png"/>
            </div>
            <div class="fr intro">
                <div class="title"><h4>MySQL8.0跨平台编程实践</h4>
...
<script type="text/javascript">$(".buy,.cart").click(function () {
    <%
        session.setAttribute("courseName","MySQL8.0跨平台编程实践");
        session.setAttribute("location","011.png");
    %>
});</script>
</body>
</html>