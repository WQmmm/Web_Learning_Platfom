...
<div class="detCon">
    <div class="proDet wrapper">
        <div class="proCon clearfix">
            <div class="proImg fl"><img class="det" src="../img/sql/012.jpg"/>
            </div>
            <div class="fr intro">
                <div class="title"><h4>MySQL数据库原理</h4>
...
<script type="text/javascript">$(".buy,.cart").click(function () {
    <%
        session.setAttribute("courseName","MySQL数据库原理");
        session.setAttribute("location","012.jpg");
    %>
});</script>
</body>
</html>